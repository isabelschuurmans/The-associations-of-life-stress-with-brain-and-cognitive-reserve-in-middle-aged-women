...
implist_c_women <- implist_c[implist_c$MOTHER %in% non_imp_df$MOTHER[which(non_imp_df$ethni == 0)],]
implist_ethni <- as.mids(implist_c_women)
...
model_imp_pls_br <- runMI(sm_br, data = implist_ethni, fun = "sem", estimator = "MLR", std.lv = T)
...
# get model stats imputed model
model_imp_pls_cr <- runMI(sm_cr, data = implist_ethni, fun = "sem", estimator = "MLR", std.lv = T)
...
model_le_br <- with(implist_ethni, lm(healthy_appearing ~ scale(LE_domain_score) + age_at_scan))
...
model_cs_br <- with(implist_ethni, lm(healthy_appearing ~ scale(CS_domain_score) + age_at_scan))
...
model_ps_br <- with(implist_ethni, lm(healthy_appearing ~ scale(PS_domain_score) + age_at_scan))
...
model_is_br <- with(implist_ethni, lm(healthy_appearing ~ scale(IS_domain_score) + age_at_scan))
...
# get model stats imputed model
model_imp_le_cr <- runMI(sm_cr_le, data = implist_ethni, fun = "sem", estimator = "MLR", std.lv = T)
...
# get model stats imputed model
model_imp_ce_cr <- runMI(sm_cr_ce, data = implist_ethni, fun = "sem", estimator = "MLR", std.lv = T)
...
# get model stats imputed model
model_imp_ps_cr <- runMI(sm_cr_ps, data = implist_ethni, fun = "sem", estimator = "MLR", std.lv = T)
...
# get model stats imputed model
model_imp_is_cr <- runMI(sm_cr_is, data = implist_ethni, fun = "sem", estimator = "MLR", std.lv = T)
...
model_all_br <- with(implist_ethni, lm(healthy_appearing ~ scale(LE_domain_score) + scale(CS_domain_score) + scale(PS_domain_score) + scale(IS_domain_score) + age_at_scan))
...
# get model stats imputed model
model_imp_all_cr <- runMI(sm_all_cr, data = implist_ethni, fun = "sem", estimator = "MLR", std.lv = T)
...
table_ethni <- rbind(table2, table3)
write.xlsx(table_ethni, 'table_sens_ethnicity_western.xlsx')
...
implist_c_women <- implist_c[implist_c$MOTHER %in% non_imp_df$MOTHER[which(non_imp_df$ethni == 1)],]
implist_ethni <- as.mids(implist_c_women)
...
table_ethni <- rbind(table2, table3)
write.xlsx(table_ethni, 'table_sens_ethnicity_nonwestern.xlsx')
