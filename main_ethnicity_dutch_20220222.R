...
implist_c_women <- implist_c[implist_c$MOTHER %in% non_imp_df$MOTHER[which(ethnicities$ETHNMv2 == 1)],]
...
write.xlsx(table2, 'table_sens_ethnicity_western_dutch.xlsx')
...
implist_c_women <- implist_c[implist_c$MOTHER %in% non_imp_df$MOTHER[which(ethnicities$ETHNMv2 == 5 | ethnicities$ETHNMv2 == 6)],]
implist_ethni <- as.mids(implist_c_women)
...
write.xlsx(table2, 'table_sens_ethnicity_nonwestern_dutch.xlsx')
